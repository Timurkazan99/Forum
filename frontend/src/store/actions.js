...
export const setPostErrorCreator = (payload) => ({ type: SET_POST_ERROR, payload });
...
export const setCommentsErrorCreator = (payload) => ({ type: SET_COMMENTS_ERROR, payload });
...
export const setUserErrorCreator = (payload) => ({ type: SET_USER_ERROR, payload });
